...
import { registerAdmin } from "@/app/actions/adminAuthActions";
import {
  ShieldCheck,
  Disc3,
  AlertCircle,
      ...
      <div className="w-full max-w-md bg-zinc-900 border border-red-900/40 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-xs mt-1">
            Create Admin Account for Red Monkey Suite
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              name="fullName"
              required
              placeholder="e.g. Master DJ Admin"
          ...
          <div>
            <label className="block text-[10px] font-bold uppercase text-zinc-400 mb-1 flex items-center gap-1.5">
              <Lock className="w-3.5 h-3.5 text-red-500" /> Secret Password
            </label>
            <input
              type="password"
              name="password"
